...
function showAbout() {
    const aboutMessage = `Наш проект - это команда профессионалов, настоящих ремесленников которые любят свое дело, всегда работающих на достижение лучшего результата. Мы всегда стремимся показать уникальность нашего продукта.

Наша миссия.

В наших деликатесах мы хотим передать чистый вкус продукта, чтобы вы могли в полной мере ощутить завораживающее волшебство тундры, через вкусовые, гастрономические впечатления.
...
Для вас мы стараемся раскрыть всю многогранность гастрономических особенностей мяса северного оленя, а так же все уникальные свойства и качества этого продукта, которые по праву считаются непревзойденными.`;
